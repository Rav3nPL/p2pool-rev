...
def run():
    ...
    parser.add_argument('--net',
        help='use specified network (default: revcoin)',
        action='store', choices=sorted(realnets), default='revcoin', dest='net_name')
    ...
    parser.add_argument('--give-author', metavar='DONATION_PERCENTAGE',
        help='donate this percentage of work towards the development of p2pool (default: 0)',
